...
![Компиляция текста программы](image/l4.png){ #fig:005 width=70% }
...
![Компиляция текста программы](image/l5.png){ #fig:006 width=70% }
...
![Передача объектного файла на обработку компоновщику](image/l6.png){ #fig:007 width=70% }
...
![Передача объектного файла на обработку компоновщику](image/l7.png){ #fig:008 width=70% }

## Запуск исполняемого файла

Запускаю на выполнение созданный исполняемый файл hello (рис. [-@fig:009]).

![Запуск исполняемого файла](image/l8.png){ #fig:009 width=70% }

## Выполнение заданий для самостоятельной работы.

С помощью утилиты cp создаю в текущем каталоге копию файла hello.asm с именем lab4.asm (рис. [-@fig:010]).

![Создание копии файла](image/l9.png){ #fig:010 width=70% }
...
![Добавление файлов на GitHub](image/l15.png)(image/l16.png){ #fig:017 width=70% }

Отправляю файлы на сервер с помощью команды git push (рис. [-@fig:018]).

![Отправка файлов](image/l17.png){ #fig:018 width=70% }
